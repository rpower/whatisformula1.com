var documents = [{
    ...
    "title": "Calendar",
    "body": "The 2021 Formula 1 season will feature 23 races including the returning Dutch Grand Prix. The next race is the {{ next_race }} held in on the . Below is the calendar of races that have been confirmed so far for the 2021 Formula 1 season:       Race       Date    {%- for race in site. data. races -%}          {{ race. name }}          {{ race. race-date | date:  %d %b  }}      {%- endfor -%}"},{
    "id": 2,
